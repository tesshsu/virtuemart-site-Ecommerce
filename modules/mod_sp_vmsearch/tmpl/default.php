...
<div class="<?php echo $moduleclass_sfx; ?> sp-vmsearch" id="sp-vmsearch-<?php echo $module_id ?>">
    <form action="<?php echo JRoute::_('index.php?option=com_virtuemart&view=category&search=true&limitstart=0' ); ?>" method="get">
        ...
        <div class="sp-vmsearch-categorybox">
            ...
            <div class="cat-button dropdown-toggle sp-vmsearch-category-name">
                <div class="category-name-wrapper">
                    <span class="category-name"><?php echo JText::_('SP_VMSEARCH_ALL_CATEGORIES') ?>aaaa</span>
                </div>
                <i class="icon-angle-down">&nbsp;</i>
            </div>

            <select name="virtuemart_category_id" class="sp-vmsearch-categories">
                <option value="0" data-name="<?php echo JText::_('SP_VMSEARCH_ALL_CATEGORIES') ?>"><?php echo JText::_('SP_VMSEARCH_ALL_CATEGORIES') ?>aaaaa</option>
                <?php
        ...
        <div class="search-button-wrapper">
            <button type="submit" class="search-button"><?php echo JText::_('SP_VMSEARCH_SEARCH_BUTTON') ?>bbbb</button>
        </div>            
