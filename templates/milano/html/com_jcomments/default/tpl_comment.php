...
?>
<span> &mdash; </span><span class="comment-title">  <?php echo $comment->title; ?></span>  
<?php
				}
?>
<?php
...
?>
<span class="comment-date"><?php echo JCommentsText::formatDate($comment->date, JText::_('ULA_DATETIME_FORMAT')); ?></span>
...
?>
 <span class="space">/</span> <a href="#" onclick="jcomments.showReply(<?php echo $comment->id; ?>,1); return false;"><?php echo JText::_('BUTTON_REPLY_WITH_QUOTE'); ?></a>  
