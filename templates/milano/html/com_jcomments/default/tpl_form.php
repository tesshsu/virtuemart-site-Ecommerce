...
<?php echo $htmlBeforeForm; ?> 
	    ...
	    <div class="ula_blog-comment">
             <div class="ula_header"> 
        				<h3 class="coments_title"><?php echo JText::_('ULA_FORM_COMMENT_HEADER'); ?></h3>
             </div> 
        </div>
...
?>
	<div class="comment-form-comment col-md-12 col-xs-12">	
        <label for="comment"><?php echo JText::_('FORM_CONTENT') ?></label>
		<textarea id="comments-form-comment" placeholder="" name="comment" rows="8" tabindex="5"></textarea>	
	</div>
<?php
...
?>
        <div class="comment-form-author col-xs-4">		
            <label for="author"><?php echo JText::_('FORM_NAME') ?></label>	 
        	<input id="comments-form-name" placeholder="" type="text" name="name" value="" maxlength="<?php echo $this->getVar('comment-name-maxlength');?>" size="22" tabindex="1" />							
        </div>
<?php
		}
...
?>
		<div class="comment-form-email col-xs-4"> 
            <label for="email"><?php echo JText::_('FORM_EMAIL') ?></label>
			<input id="comments-form-email" placeholder="" type="text" name="email" value="" size="22" tabindex="2" />
		</div>
<?php
		}
...
?>
		<div class="col-md-12 col-xs-12"> 
			<input id="comments-form-title" placeholder="<?php echo JText::_('FORM_TITLE') ?>" type="text" name="title" value="" size="22" tabindex="4" />			
		</div>
<?php
		}
?>
...
?>
<div class="comments-form-buttons col-md-12 col-xs-12 text-center">
	<div id="comments-form-send"><a href="#" class="hasTooltip" tabindex="7" onclick="jcomments.saveComment();return false;" title="<?php echo JText::_('FORM_SEND_HINT'); ?>"><?php echo JText::_('ULA_COMMENT_SEND'); ?></a></div> 
