...
<div id="ulathemes-carousel-content<?php echo $module->id; ?>" class="ulathemes-carousel-content owl-carousel owl-theme <?php echo $classSuffix; ?>">
	...
	<div class="item wow fadeInRight" data-wow-delay="200ms">
		...
		<?php $col_text = ' col-xs-12 col-sm-6'; ?>
		<div class="group-blogs row">
			<div class="image-block col-xs-12 col-sm-6 columns">
		...
		<?php endif; ?>
			...
			<div class="columns<?php echo $col_text; ?>">
				<div class="text-block blog_info align_left">
					<!-- Date -->
					<?php if($showCreatedDate) : ?>
					<span class="post-date"><?php echo JHTML::_('date', $created, 'd, F');?></span>
