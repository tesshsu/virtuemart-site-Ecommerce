...
?>
<div class="row<?php echo $tpl_params->get('show_post_format') ? ' has-post-format': ''; ?>">
		...
		<div class="blog_info align_left">   
            <div class="post-date">  
                <?php if ($params->get('show_publish_date')) : ?>
        			<?php echo JLayoutHelper::render('joomla.content.info_block.publish_date_category', array('item' => $this->item, 'params' => $params)); ?>
        		<?php endif; ?> 
            </div>
