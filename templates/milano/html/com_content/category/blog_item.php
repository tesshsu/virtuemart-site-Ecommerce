...
?>
<div class="blog-item<?php echo $tpl_params->get('show_post_format') ? ' has-post-format': ''; ?>">
	...
	<div class="entry-media">
		<?php
			...
			// Icon Post Format
			echo JLayoutHelper::render('joomla.content.post_formats.icons',  $post_format);
		?>
	</div>
	...
	<div class="entry-header">
		<div class="row">
			<div class="col-lg-2 columns text-center">
				<?php if ($useDefList) : ?>
				<?php echo JLayoutHelper::render('joomla.content.info_block.block_extra', array('item' => $this->item, 'params' => $params)); ?>
				<?php endif; ?>
			</div>
			<div class="introtext col-lg-10 columns">
