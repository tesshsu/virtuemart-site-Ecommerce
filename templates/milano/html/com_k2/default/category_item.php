...
<div class="blog-item group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
     ...
     <span class="sep"> | </span>
	  ...
	  <div class="tags">
		  <i class="fa fa-tags" aria-hidden="true"></i> 
		    ...
		    <a href="<?php echo $tag->link; ?>"><?php echo $tag->name; ?></a><?php if($i != (count($this->item->tags)-1)) echo ','; ?>
		    <?php endforeach; ?> 
		  <div class="clr"></div>
	  </div>
	  <?php endif; ?>
