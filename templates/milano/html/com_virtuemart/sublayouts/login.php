...
<?php   }
    ...
    <div class="checkout-page panel-body login-users">
    <form id="com-form-login" action="<?php echo $url; ?>" method="post" name="com-login" > 
        ...
        <div class="row"> 
            <div class="col-sm-6 col-xs-12 form-row-wide" id="com-form-login-username">
                <label for="username" class="required"><?php echo vmText::_('COM_VIRTUEMART_USERNAME'); ?></label>
                <input style="width: 100%;"  type="text" name="username" class="inputbox" size="18" title="<?php echo vmText::_('COM_VIRTUEMART_USERNAME'); ?>" value="<?php echo vmText::_('COM_VIRTUEMART_USERNAME'); ?>" onblur="if(this.value=='') this.value='<?php echo addslashes(vmText::_('COM_VIRTUEMART_USERNAME')); ?>';" onfocus="if(this.value=='<?php echo addslashes(vmText::_('COM_VIRTUEMART_USERNAME')); ?>') this.value='';" />
            </div>   
            <div class="col-sm-6 col-xs-12 form-row-wide" id="com-form-login-password">
                <label for="password" class="required"><?php echo vmText::_('COM_VIRTUEMART_PASSWORD'); ?></label>
        ...
        <div class="form-row-wide" id="com-form-login-remember">
            <input type="submit" name="Submit" class="button button-style1" value="<?php echo vmText::_('COM_VIRTUEMART_LOGIN') ?>" />
            <?php if (JPluginHelper::isEnabled('system', 'remember')) : ?> 
          <?php endif; ?>
            <a href="<?php echo JRoute::_('index.php?option=com_users&view=remind'); ?>" rel="nofollow" class="forgot">
