...
?>
		...
		<form method="post" class="product js-recalculate addtocart-area" action="<?php echo JRoute::_ ('index.php?option=com_virtuemart',false); ?>">
			<?php
                if(!empty($rowHeights['customfields']) && $view == 'productdetails') echo shopFunctionsF::renderVmSubLayout('customfields',array('product'=>$product,'position'=>'addtocart'));
