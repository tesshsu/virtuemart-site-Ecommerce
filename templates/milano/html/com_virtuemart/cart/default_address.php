...
?>
<div class="billto-shipto  panel-body">
<div class="row">
	<div class="col-sm-6 col-xs-12">

		<span class="vm-info-title">
		...
		<div class="output-billto">
			...
			foreach ($this->cart->BTaddress['fields'] as $item) {
				// ISSUE 131 checkout page show Billing address France if not login
		...
		?>	
		<!--ISSUE debug for IE Firefox link not working-->
		<button class="vm-btn-addAddress">
		<a class="vm-btn-addAddress <?php echo $this->pointAddress ?>" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=BT', $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
	...
	<div class="col-sm-6 col-xs-12">
		...
		<div class="output-shipto">
			...
			if($this->cart->user->virtuemart_user_id==0){
				...
				echo vmText::_ ('COM_VIRTUEMART_USER_LOGIN_MS');
		...
		<!--ISSUE debug for IE Firefox link not working-->
		<button class="vm-btn-addAddress">
		<a class="vm-btn-addAddress" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=ST&virtuemart_user_id[]=' . $this->cart->lists['current_id'], $this->useXHTML, $this->useSSL) ?>" rel="nofollow">
			<?php echo vmText::_ ('COM_VIRTUEMART_USER_FORM_ADD_SHIPTO_LBL'); ?>
		</a>
		</button>
		<p class="checkoutAlert"> <?php echo vmText::_ ('COM_VIRTUEMART_USER_FORM_EDIT_ALER_INFO'); ?></p>
		<br><br>
