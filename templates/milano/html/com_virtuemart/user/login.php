...
<?php   }
	...
	<h2><?php echo vmText::_('COM_VIRTUEMART_USER_LOGIN'); ?></h2>
    <p class="sub-heading"><?php echo vmText::_('COM_VIRTUEMART_ORDER_CONNECT_FORM'); ?></p>  
    <div class="row"> 
    <div class="col-sm-6 col-xs-12 form-row-wide">
        <label for="email" class="required"><?php echo vmText::_('COM_VIRTUEMART_USERNAME'); ?></label>
        <input type="email" name="username" id="email" required="required" />
    </div>   
    <div class="col-sm-6 col-xs-12 form-row-wide">
    ...
    <div class="form-row-wide">
            ...
            <a href="<?php echo JRoute::_('index.php?option=com_users&view=reset'); ?>" rel="nofollow" class="forgot">
