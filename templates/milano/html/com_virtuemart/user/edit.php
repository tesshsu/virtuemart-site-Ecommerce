...
<div class="row-set">
	<div class="account-edit panel-body new-users block-border">
		<?php
		if($this->userDetails->virtuemart_user_id==0) {
		        echo '<h2>'.vmText::_('COM_VIRTUEMART_YOUR_ACCOUNT_REG').'<span>'.vmText::_('COM_VIRTUEMART_SHOPPER_FORM_LBL_OBJ').'</span></h2>';
		}
		?>
