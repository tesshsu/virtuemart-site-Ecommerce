...
<span class="userfields_info"><?php echo vmText::_('COM_VIRTUEMART_ORDER_LIST_LBL'); ?></span>
<div id="editcell">
	...
	<?php
		...
		foreach ($this->orderlist as $i => $row) {
			...
			<tr class="<?php echo "row$k"; ?>">
				<td align="left">
					<a href="<?php echo $editlink; ?>" rel="nofollow"><?php echo $row->virtuemart_order_id; ?></a>
				</td>
				<td align="left">
