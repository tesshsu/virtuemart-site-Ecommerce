	...
	<div class = "vmshop-account account-login">		
		...
		<div class="row-set row">
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<div class="panel-body content new-users block-border">
					<h2><?php echo JText::_('VM_LANG_HAVE_NOT_ACCOUNT'); ?></h2>
					<p><?php echo JText::_('VM_LANG_REGISTER_DES'); ?></p>
					<ul>
						<li style="padding-bottom: 10px;"><i class="fa fa-dot-circle-o" aria-hidden="true"></i>&nbsp;<?php echo JText::_('VM_LANG_REGISTER_DES_ONE'); ?></li>
						<li><i class="fa fa-dot-circle-o" aria-hidden="true"></i>&nbsp;<?php echo JText::_('VM_LANG_REGISTER_DES_THREE'); ?></li>
					</ul>
				</div>				
				<div class="buttons-set">
					<button type="button" title="<?php echo JText::_('VM_LANG_REGISTRATION'); ?>" class="button-theme" onclick="window.location='<?php echo JRoute::_('index.php?option=com_virtuemart&view=user&task=edit', FALSE); ?>'"><span><span><?php echo JText::_('VM_LANG_REGISTRATION'); ?></span></span></button>
				</div>				
			</div>
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<form id="com-form-login" action="<?php echo JRoute::_('index.php', $this->useXHTML, $this->useSSL); ?>" method="post" name="com-login" >
					<fieldset class="panel-body content login-users block-border userdata">				
					...
					<div class="buttons-set">
						<input type="submit" name="Submit" class="button-theme default" value="<?php echo vmText::_('COM_VIRTUEMART_LOGIN'); ?>" />
						<div class="floatleft">
