...
?>
<div class="sp-vmsearch" id="sp-vmsearch-<?php echo $module_id ?>">
    <form action="<?php echo JRoute::_('index.php?option=com_virtuemart&view=category&search=true&limitstart=0' ); ?>" method="get">
        ...
        <div class="search-button-wrapper">
            <button type="submit" class="search-button"><i class="pe-7s-search"></i><span><?php echo JText::_('SP_VMSEARCH_SEARCH_BUTTON') ?></span></button>
        </div>            
        <div class="search-input-wrapper">
            <input type="text" name="keyword" autocomplete="off" class="sp-vmsearch-box" value="<?php echo JRequest:: getVar('keyword') ?>" placeholder="<?php echo JText::_('SP_VMSEARCH_SEARCH_BUTTON') ?>"/>
        </div>
    </form>
</div>
...
<script type="text/javascript">
    jQuery(function($){
            ...
            $('#sp-vmsearch-<?php echo $module_id ?> .sp-vmsearch-categories').on('change', function(event){
                    ...
                    //ISSUE 149 improvement of research module for virtuemart product search
