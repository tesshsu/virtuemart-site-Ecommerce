			...
			<div>
				<div class="container">
					<?php  if ($this->error->getCode() == '404') { ?>
						<h1 class="error404-code"><span>404</span></h1>
					<?php } else { ?>
                    ...
                    <h3>Sorry, but the page you are looking for is not found. Please, make sure </h3>
					<h3>you have typed the current URL.</h3> 
					<a class="previus-page" href="<?php echo $this->baseurl; ?>/" title="<?php echo JText::_('HOME'); ?>"><?php echo JText::_('HELIX_GO_BACK'); ?></a>
