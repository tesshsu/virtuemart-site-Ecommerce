...
function sp_image_content_addon($atts){
	...
	if($image_alignment=='left') {
		$eontent_class = ' sppb-col-sm-offset-7';
	} else {
		$eontent_class = '';
	}
	...
	if($image && $title) {
		...
		$output .= '<div class="sppb-col-sm-5'. $eontent_class .'">';
		...
		$output .= '<'.$heading_selector.' class="sppb-addon-title sppb-image-content-title" style="' . $title_style . '">' . $title . '</'.$heading_selector.'>';
