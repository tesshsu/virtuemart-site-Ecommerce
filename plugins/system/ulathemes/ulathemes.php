<?php
/**
* @package Ulathemes Template
* @author Ulathemes http://www.ulathemes.com
* @copyright Copyright (c) 2010 - 2015 Ulathemes
...
class plgSystemUlathemes extends JPlugin
{
	...
	public function onAfterInitialise()
	{
		...
		$template 		= $this->params->get('cookieName', 'ulathemes_template');
		...
		$current = plgSystemUlathemes::getCurrentTemplate();
