...
//		}
	  ...
	  if ($this->io_method() == 'socket') {
		...
		socket_set_timeout( $this->fp, $response_timeout,1);
	...
	function nusoap_parser($xml,$encoding='UTF-8',$method='',$decode_utf8=true){
		...
		if(!empty($xml)){
			...
			if(!xml_parse($this->parser,$xml,true)){
				...
				//vmdebug('Soap parser error',$encoding, $xml);
				die;
			} else {
...
class nusoap_client extends nusoap_base  {
	...
	*/
	function call($operation,$params=array(),$namespace='http://tempuri.org',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
		...
		//vmdebug("call: operation=$operation, namespace=$namespace, soapAction=$soapAction, rpcParams=$rpcParams, style=$style, use=$use, endpointType=$this->endpointType");
