...
/*Picture in top*/
.acymailing_fulldiv form{background:url("images/milano/promo_bg.jpg") no-repeat top; background-size: cover; width:100%; background-color:#fff; height:<?php echo $height;?>px !important; padding:0 !important}
.acymailing_fulldiv form div.acymailing_module_form{padding:30px !important; display: inline-block; width: 100%; box-sizing: border-box;}
/*Intro text area*/
...
#fancybox-outer #fancybox-content {margin: 0 !important; padding: 0 !important;}
</style>
</head>
