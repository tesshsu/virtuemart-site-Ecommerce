...
{
    if (isNewProject) {
      window.location.href='index.php?option=com_slideshow&view=slideshow&task=slideshow.addProject&sel='+sel+'&parentId='+parentId;
      return;        
    }
...
function Edit(src, parentId, elementId) {
    ...
    var image_url = document.getElementById("image_url"+parentId);
    image_url.value = par_images[parentId]; 
	Joomla.submitbutton('slideshow.save');	
}
