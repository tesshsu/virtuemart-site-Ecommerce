...
<div style="text-align: left;">
	<table class="adminlist table table-striped" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<th width="8%"><?php echo $this->sort ('virtuemart_order_id', 'COM_VIRTUEMART_ORDER_LIST_NUMBER')  ?></th><?php //MAJ PAR BRUNO CAMELEON ?>
			...
			<th><?php echo $this->sort ('order_number', 'COM_VIRTUEMART_ORDER_LIST_ID')  ?></th>
...
;
			...
			<tr class="row<?php echo $k; ?>">
				...
				//BRUNO CAMELEONS : MODIFICATION DE L'ID DE COMMANDE AFFICHEE ?>
				<td><?php echo JHtml::_ ('link', JRoute::_ ($link, FALSE), $order->virtuemart_order_id, array('title' => vmText::_ ('COM_VIRTUEMART_ORDER_EDIT_ORDER_NUMBER') . ' ' . $order->virtuemart_order_id)); ?></td>
				...
				<td><?php echo JHtml::_ ('link', JRoute::_ ($link, FALSE), $order->order_number, array('title' => vmText::_ ('COM_VIRTUEMART_ORDER_EDIT_ORDER_ID') . ' ' . $order->virtuemart_order_id)); ?></td>
