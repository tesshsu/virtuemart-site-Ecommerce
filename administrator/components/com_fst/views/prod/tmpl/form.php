...
function doTranslate()
{
	...
	var url = '<?php echo JRoute::_('index.php?option=com_fst&view=translate&tmpl=component', false); ?>&data=' + encodeURIComponent(JSON.stringify(to_translate));
...
<div>
	<fieldset class="adminform">
		...
		<?php FSTAdminHelper::LA_Form($this->prod, true); ?>
		<tr>
			<td width="135" align="right" class="key">
				<label for="image">
			...
			<td>
				...
				<?php echo JText::_("FOUND_IN_IMAGES_FST_PRODUCTS"); ?>
			</td>
		</tr>		
		<tr>
			<td width="135" align="right" class="key">
...
<input type="hidden" name="translation" id="translation" value="<?php echo htmlEntities($this->prod->translation); ?>" />
