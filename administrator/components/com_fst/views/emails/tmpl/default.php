...
?>
<form action="<?php echo FSTRoute::x( 'index.php?option=com_fst&view=faqs' );?>" method="post" name="adminForm" id="adminForm">
<div id="editcell">
    ...
    for ($i=0, $n=count( $this->data ); $i < $n; $i++)
    {
        ...
        $link = FSTRoute::x( 'index.php?option=com_fst&controller=email&task=edit&cid[]='. $row->id );
