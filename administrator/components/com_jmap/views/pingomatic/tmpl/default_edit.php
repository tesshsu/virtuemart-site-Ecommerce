					...
					<tr>
						...
						<td class="right_details">
							...
							<div class="panel panel-success">
								...
								<div class="panel-body">
									<div id="specialized">
										<div class="service_control"><fieldset class="radio btn-group"><?php echo $this->lists['chk_audioweblogs'];?></fieldset><a href="http://www.weblogs.com/" target="_blank"><label class="as label label-info">Audio.Weblogs</label></a></div>
