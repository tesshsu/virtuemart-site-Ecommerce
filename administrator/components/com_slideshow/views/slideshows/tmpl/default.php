...
<div id="h-main-container" class="span10 h-toggle-main">
    <div class="">
        <?php $path_site2 = JUri::root()."media/com_slideshow/images";
        ?>
        <style>
            .free_version_banner {
                position:relative;
	...
	<form action="<?php echo JRoute::_('index.php?option=com_slideshow'); ?>" method="post" name="adminForm" id="adminForm">
