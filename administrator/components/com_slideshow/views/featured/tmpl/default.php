...
<form action="<?php echo JRoute::_('index.php?option=com_slideshow'); ?>" id="application-form" method="post" name="adminForm" class="form-validate" style="margin-top:10px">
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_slideshow/images/lightbox.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_slideshow/images/lightbox.png'; ?>"></a>
                </div>
            </div>
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_slideshow/images/gallery.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_slideshow/images/gallery.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
      ...
      <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_slideshow/images/catalog.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_slideshow/images/catalog.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_slideshow/images/map.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_slideshow/images/map.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_slideshow/images/portfolio.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_slideshow/images/portfolio.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
    ...
    <div class="left-block">
            <div class="main-image-block">
                <a href="<?php echo JUri::root(). 'media/com_slideshow/images/slider.png'; ?>" rel="content"><img src="<?php echo JUri::root(). 'media/com_slideshow/images/slider.png'; ?>"></a>
            </div>
    </div>
    <div class="right-block">
...
It is a quick and easy way to add custom sliders to the Joomla websites.The slider allows having unlimited amount of images with their titles and descriptions. </p>
       ...
       <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_slideshow/images/videogallery.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_slideshow/images/videogallery.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
