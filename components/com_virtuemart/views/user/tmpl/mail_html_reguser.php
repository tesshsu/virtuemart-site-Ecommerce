...
<html>
	...
	<style type="text/css">
	    ...
	    table.html-email {margin:10px auto;background:#fff;border:solid #dad8d8 1px;border-radius: 20px;}
	    .html-email tr{border-bottom : 1px solid #eee;}
	    span.grey {color:#666;}
	    span.date {color:#666;font-size: 10px;}
	    a.default:link, a.default:hover, a.default:visited {color:#666;line-height:25px;background: #eee;margin: 10px ;padding: 3px 8px 1px 8px;border: solid #CAC9C9 1px;border-radius: 4px;-webkit-border-radius: 4px;-moz-border-radius: 4px;text-shadow: 1px 1px 1px #f2f2f2;font-size: 14px;background-position: 0px 0px;display: inline-block;text-decoration: none;}
	    a.default:hover {color:#333;background: #88c2e6;font-size: 16px;font-weight: 600;}
	    .cart-summary{ }
	    .html-email th { background: #ccc;margin: 0px;padding: 10px;}
	    .sectiontableentry2, .html-email th, .cart-summary th{ margin: 0px;padding: 10px;font-size: 14px;border-top-left-radius:20px;border-top-right-radius:20px;}
	    .sectiontableentry1, .html-email td, .cart-summary td {margin: 0px;padding: 10px;font-size: 12px;color: #666;}
	</style>

    </head>

    <body style="background: #F2F2F2;word-wrap: break-word;">
	<div style="background-color: #88c2e6;" width="100%">
