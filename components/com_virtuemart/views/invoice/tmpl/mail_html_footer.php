...
/* GENERAL FOOTER FOR ALL MAILS */
    echo vmText::_('COM_VIRTUEMART_'.$isEnglish.'MAIL_FOOTER_LINE1' );
    echo '<br/>';
    echo vmText::_('COM_VIRTUEMART_'.$isEnglish.'MAIL_FOOTER_LINE2' );
    echo '<br/>';
	echo vmText::_('COM_VIRTUEMART_'.$isEnglish.'MAIL_FOOTER' ) . '<a href="'.$link.'">'.$this->vendor->vendor_name.'</a>';
        echo '<br/>';
