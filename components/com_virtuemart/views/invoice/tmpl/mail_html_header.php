...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="html-email">
	...
	<tr>
		<td colspan="2">
			<strong><?php echo vmText::sprintf ('COM_VIRTUEMART_'.$isEnglish .'MAIL_SHOPPER_NAME', $this->civility . ' ' . $this->orderDetails['details']['BT']->first_name . ' ' . $this->orderDetails['details']['BT']->last_name); ?></strong><br/>
		</td>
	</tr>
</table>
