...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="html-email">
  ...
  <tr>
    <td width="30%">
		<?php echo vmText::_('COM_VIRTUEMART_'.$isEnglish.'MAIL_SHOPPER_YOUR_ORDER'); ?><br />
		<strong><?php echo $this->orderDetails['details']['BT']->virtuemart_order_id ?></strong>

	</td>
    <td width="30%">
		<?php echo vmText::_('COM_VIRTUEMART_'.$isEnglish.'MAIL_SHOPPER_YOUR_PASSWORD'); ?><br />
    ...
    <td width="40%">
    	<p>
			...
			<?php echo vmText::_('COM_VIRTUEMART_'.$isEnglish.'MAIL_SHOPPER_YOUR_ORDER_LINK'); ?></a>
		</p>
	</td>
  </tr>
  <tr>
    <td colspan="3"><p>
				<?php echo vmText::sprintf('COM_VIRTUEMART_'.$isEnglish.'MAIL_SHOPPER_TOTAL_ORDER',$this->currency->priceDisplay($this->orderDetails['details']['BT']->order_total,$this->user_currency_id) ); ?></p></td>
  </tr>
	<tr>
  <td colspan="3"><p>
				<?php echo vmText::sprintf('COM_VIRTUEMART_'.$isEnglish.'MAIL_ORDER_STATUS',vmText::_($this->orderDetails['details']['BT']->order_status_name)) ; ?></p></td>
  </tr>
  ...
  <tr>
    <td colspan="3">
		<?php echo vmText::sprintf('COM_VIRTUEMART_'.$isEnglish.'MAIL_SHOPPER_QUESTION',nl2br($this->orderDetails['details']['BT']->customer_note)) ?>
