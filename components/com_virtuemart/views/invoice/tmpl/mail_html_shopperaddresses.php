...
<table class="html-email" cellspacing="0" cellpadding="0" border="0" width="100%">  <tr  >
	<th width="50%">
	    <?php echo vmText::_('COM_VIRTUEMART_'.$isEnglish.'USER_FORM_BILLTO_LBL'); ?>
	</th>
	<th width="50%" >
	    <?php echo vmText::_('COM_VIRTUEMART_'.$isEnglish.'USER_FORM_SHIPTO_LBL'); ?>
	</th>
    </tr>
    <tr>
	<td valign="top" width="50%">
		...
		if (!empty($field['value'])) {
			...
			<?php if ($field['name'] != 'title' and $field['name'] != 'first_name' and $field['name'] != 'middle_name' and $field['name'] != 'zip' and $field['name'] != 'company') { ?>
			    <br class="clear" />
			    <?php
			}
		    }
