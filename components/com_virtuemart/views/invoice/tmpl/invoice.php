...
if ($this->_layout == "invoice") {
    ...
    //BRUNO CAMELEONS : Changement de l'id
	$document->setTitle(vmText::_('COM_VIRTUEMART_ORDER_PRINT_PO_NUMBER') . ' ' . $this->orderDetails['details']['BT']->virtuemart_order_id . ' ' . $this->vendor->vendor_store_name);
}
