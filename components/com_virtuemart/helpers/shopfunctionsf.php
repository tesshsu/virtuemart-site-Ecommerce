...
class shopFunctionsF {
	...
	static public function loadOrderLanguages($language = 0){
		...
		if($language) {
			VmConfig::loadJLang('com_virtuemart', false, $language);
			VmConfig::loadJLang('com_virtuemart_shoppers', false, $language);
			VmConfig::loadJLang('com_virtuemart_orders', false, $language);
